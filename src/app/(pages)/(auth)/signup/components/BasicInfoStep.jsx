...
const BasicInfoStep = ({
  ...
  try {
    ...
    socialConfig = authConfig.socialProviders || {};
  } catch (error) {
  ...
  const handleSocialSignup = async (provider) => {
    ...
    try {
      await onSocialSignup(provider, selectedRole);
    } finally {
  ...
  return (
    <div className="space-y-8 animate-fadeIn">
      ...
      {/* Social Auth Section - Moved to Top */}
          ...
          <div className="flex gap-4 justify-center">
            {googleEnabled && (
              <button
                ...
                className="group flex-1 max-w-[140px] p-4 rounded-2xl border border-base-300/60 
                         hover:border-primary/30 bg-base-100 hover:bg-primary/5 
                         transition-all duration-300 hover:shadow-lg hover:-translate-y-1 
                         disabled:opacity-50 flex flex-col items-center gap-3"
              >
                ...
                <span className="text-xs font-medium text-base-content/80 group-hover:text-base-content">
                  Google
                </span>
              </button>
            )}
            ...
            {githubEnabled && (
              <button
                ...
                disabled={isSubmitting || socialLoading}
                className="group flex-1 max-w-[140px] p-4 rounded-2xl border border-base-300/60 
                         hover:border-base-content/30 bg-base-100 hover:bg-base-content/5 
                         transition-all duration-300 hover:shadow-lg hover:-translate-y-1 
                         disabled:opacity-50 flex flex-col items-center gap-3"
              >
                <div className="relative">
                  {socialLoading === "github" ? (
                    ...
                    <svg
                      className="w-6 h-6 text-base-content group-hover:text-base-content/80"
                      viewBox="0 0 24 24"
                      fill="currentColor"
                    >
        ...
        <div className="lg:col-span-1 space-y-4">
          <div className="form-control">
            ...
            <div className="flex flex-col items-center lg:items-start gap-4">
              <div
                className="w-32 h-32 rounded-2xl bg-base-200 border-2 border-dashed border-base-300 
                            flex items-center justify-center overflow-hidden group hover:border-primary/40 
              ...
              <label
                className="btn btn-outline btn-sm cursor-pointer rounded-xl 
                              hover:bg-primary hover:text-primary-content transition-all duration-300"
              >
          ...
          <div className="form-control">
            ...
            <input
              ...
              className="input input-bordered w-full rounded-xl focus:ring-2 focus:ring-primary/50 
                         bg-base-200/50 transition-all duration-200"
          ...
          <div className="form-control">
            ...
            <div className="relative">
              <input
                ...
                className="input input-bordered w-full rounded-xl pr-10 focus:ring-2 focus:ring-primary/50 
                           bg-base-200/50 transition-all duration-200"
      ...
      {/* Security Features */}
      <div className="space-y-4 pt-6 border-t border-base-300/30">
      ...
      <div className="flex justify-end pt-4">
        <button
          ...
          className="btn btn-primary rounded-xl flex items-center gap-2 px-8 
