...
export default function CaseStudiesManagerPage() {
  ...
  const fetchCaseStudies = async () => {
    ...
    try {
      const res = await fetch("/api/super-admin/case-studies");
  ...
  const confirmDelete = async () => {
    ...
    try {
      ...
      const res = await fetch(`/api/super-admin/case-studies/${deleteId}`, {
        method: "DELETE",
      });
      if (res.ok) {
                          ...
                          <button
                            ...
                            onClick={async () => {
                              ...
                              const res = await fetch(
                                `/api/super-admin/case-studies/${caseStudy.id}`
                              );
                              const data = await res.json();
