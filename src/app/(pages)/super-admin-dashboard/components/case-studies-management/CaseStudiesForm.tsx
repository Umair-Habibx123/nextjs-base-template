  ...
  const handleSave = async () => {
    ...
    try {
      const res = await fetch(
        initialData?.id
          ? `/api/super-admin/case-studies/${initialData.id}`
          : `/api/super-admin/case-studies`,
        {
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-base-content/70 mt-2 text-lg leading-relaxed">
              {initialData?.id
                ? "Update your case studies content and settings"
                : "Start crafting your next amazing case studies post"}
            </p>
          </div>
        </div>
        ...
        <div className="lg:col-span-2 space-y-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="Enter your case studies post title..."
                />
          ...
          <div className="bg-linear-to-br from-base-100 to-base-200 border border-base-300/30 rounded-2xl shadow-2xl backdrop-blur-lg p-6 transition-all duration-500">
            ...
            <textarea
              ...
              placeholder="Write a short, engaging summary that will appear in case studies listings and search results..."
            />
          ...
          <div className="bg-linear-to-br from-base-100 to-base-200 border border-base-300/30 rounded-2xl shadow-2xl backdrop-blur-lg p-6 transition-all duration-500">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-base-content/60 text-sm">
                  Control where this Case Studies appears in the list
                </p>
              </div>
            </div>
