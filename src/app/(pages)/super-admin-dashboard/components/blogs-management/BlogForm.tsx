...
export default function BlogForm({ initialData, onSaved, onCancel }: any) {
  const { user } = useAuth();
  ...
  const handleSave = async () => {
    ...
    try {
      const res = await fetch(
        initialData?.id
          ? `/api/super-admin/blogs/${initialData.id}`
          : `/api/super-admin/blogs`,
        {
          ...
          <div>
            ...
            <p className="text-base-content/70 mt-2 text-lg leading-relaxed">
              {initialData?.id
                ...
                : "Start crafting your next amazing blog post"}
            </p>
          </div>
        </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-linear-to-br from-base-100 to-base-200 border border-base-300/30 rounded-2xl shadow-2xl backdrop-blur-lg p-6 transition-all duration-500">
            ...
            <textarea
              ...
              placeholder="Write a short, engaging summary that will appear in blog listings and search results..."
            />
          ...
          <div className="bg-linear-to-br from-base-100 to-base-200 border border-base-300/30 rounded-2xl shadow-2xl backdrop-blur-lg p-6 transition-all duration-500">
            ...
            <label className="flex items-center justify-between p-4 bg-base-200/50 rounded-xl border border-base-300/20 cursor-pointer hover:bg-base-300/30 transition-all duration-300">
              <div className="flex items-center gap-3">
                ...
                />
                <span className="font-semibold">Featured Blog Post</span>
              </div>
              <input
                type="checkbox"
          ...
          <div className="bg-linear-to-br from-base-100 to-base-200 border border-base-300/30 rounded-2xl shadow-2xl backdrop-blur-lg p-6 transition-all duration-500">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-base-content/60 text-sm">
                  Control where this blog appears in the list
                </p>
              </div>
            </div>
