        ...
        >
          ...
          >
            ...
            <div className="animate-fade-in">
              {ADMIN_FEATURES.appinfo && activePage === "appinfo" && (
                <AppInfoPage />
              )}
              {ADMIN_FEATURES.theme && activePage === "theme" && (
                <ThemeSettingsPage />
              )}
              {ADMIN_FEATURES.systeminfo && activePage === "systeminfo" && (
                <SystemInfoPage />
              )}
              {ADMIN_FEATURES.langmanage && activePage === "langmanage" && (
                <LanguageManagerPage />
              )}
              {activePage === "profile" && <ProfilePage />}
              {ADMIN_FEATURES.contacts && activePage === "contacts" && (
                <ContactMessagesPage />
              )}
              {ADMIN_FEATURES.newsletter && activePage === "newsletter" && (
                <NewsletterSubscribe />
              )}
              {ADMIN_FEATURES.announcement && activePage === "announcement" && (
                <AnnouncementManagerPage />
              )}
              {ADMIN_FEATURES.emailtemplates &&
                activePage === "emailtemplates" && <TemplatePage />}
              {ADMIN_FEATURES.blogs && activePage === "blogs" && (
                <BlogManagerPage />
              )}
              {ADMIN_FEATURES.projects && activePage === "projects" && (
                <ProjectManagerPage />
              )}
