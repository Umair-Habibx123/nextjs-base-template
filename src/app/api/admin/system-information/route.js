...
export async function GET() {
  try {
    ...
    // Filter valid, active interfaces only
    ...
    // Reduce heavy process list to top 8 by CPU
    const topProcesses =
      processes?.list
    ...
    // Reduce service list to top 10 running
    ...
    console.log("System info retrieved successfully:", data);
